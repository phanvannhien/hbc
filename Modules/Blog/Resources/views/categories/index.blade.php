...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <a class="btn btn-success btn-sm" href="{{route('blog_categories.index')}}">{{ trans('app.create') }}</a>
        </h1>
    ...
    <section class="content">
        ...
        <div class="row">
                        ...
                        <form action="{{ route('blog_categories.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="select-single-file">
                                    <label for="">{{ trans('blog::category.category_image') }}</label>
                                    <div class="img-item">
                            ...
                            <div class="form-group">
                                <label for="">{{ trans('blog::category.category_parent') }}</label>
                                <select name="parent_id" class="form-control" id="">
                                    <option value="0">@lang('app.select')</option>
                                    {!! \App\Helpers\NestableRender::renderSelect($cat_blog) !!}
                                </select>

                            </div>
                            <div class="form-group">
                                <label for="">{{ trans('blog::category.category_status') }}</label>
            ...
            <div class="col-sm-6">
                <div class="box">
                    <div class="box-body">
                        {!! \App\Helpers\NestableRender::renderHtml( $cat_blog ) !!}
