                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_cas" class="form-control" required value="{{ $product->product_cas }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_synonym" class="form-control" value="{{ $product->product_synonym }}" >
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="">@lang('product::product.product_grade')</label>
                                        <input type="text" name="product_grade" class="form-control" value="{{ $product->product_grade }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_concentration" class="form-control" value="{{ $product->product_concentration }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="">@lang('product::product.product_formular')</label>
                                        <input type="text" name="product_formular" class="form-control" value="{{ $product->product_formular }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_tolerance" class="form-control" value="{{ $product->product_tolerance }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="">@lang('product::product.product_neck_size')</label>
                                        <input type="text" name="product_neck_size" class="form-control" value="{{ $product->product_neck_size }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_material" class="form-control" value="{{ $product->product_material }}">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <select name="product_attribute[{{ $i  }}][product_attribute_code]" class="form-control product-code" id="">
                                                    @foreach( \Modules\Product\Entities\Attributes::all() as $item )
                                                        <option {{ ($attr->attribute_id == $item->product_attribute_code) ?'selected':''  }}
                                                                value="{{ $item->product_attribute_code }}">{{ $item->product_attribute_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" value="{{ $attr->attribute_value }}"
                                                       name="product_attribute[{{ $i  }}][attribute_value]" class="form-control product-value"
                                                       placeholder="@lang('product::product.attribute_value')">
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" value="{{ $attr->price }}"
                                                       name="product_attribute[{{ $i  }}][product_price]"
                                                       class="form-control product-price" placeholder="@lang('product::product.product_price')">
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" value="{{ $attr->sku }}"
                                                       name="product_attribute[{{ $i  }}][sku]" class="form-control product-sku" placeholder="@lang('product::product.sku')">
                                            </div>
                                            <div class="col-sm-8">
                                                <input type="text"  value="{{ $attr->availability }}"
                                                       name="product_attribute[{{ $i  }}][availability]" class="form-control product-availability" placeholder="@lang('product::product.availability')">
                                            </div>
                                            <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="product_description" id="" class="form-control editor" cols="30" rows="10">{!! $product->product_description !!}</textarea>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <select name="product_category" class="form-control" id="">
                                    ...
                                    {!! \App\Helpers\NestableRender::renderSelect($cat, $product->category_id) !!}
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <select name="product_type" class="form-control" id="">
                                    ...
                                    <option {{ ($product->product_type == 'hoachat') ? 'selected' : '' }} value="hoachat">hoachat</option>
                                    <option {{ ($product->product_type == 'chatchuan') ? 'selected' : '' }} value="chatchuan">chatchuan</option>
                                    <option {{ ($product->product_type == 'dungcu') ? 'selected' : '' }} value="dungcu">dungcu</option>
                                    <option {{ ($product->product_type == 'thietbi') ? 'selected' : '' }} value="thietbi">thietbi</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="select-single-file">
                                    <div class="img-item">
                                        <img width="" class="img-responsive" src="{{ $product->product_image }}" alt="">
                                        <input type="hidden" value="{{ $product->product_image }}" name="product_image" id="" class="form-control ">
                                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select name="product_status" id="" class="form-control">
                                    <option {{ ($product->product_status == 1) ? 'selected':'' }} value="1">{{ trans('app.show') }}</option>
                                    <option {{ ($product->product_status == 10) ? 'selected':'' }}  value="0">{{ trans('app.hide') }}</option>
                                </select>
                            </div>
                            <div class="col-sm-6">
